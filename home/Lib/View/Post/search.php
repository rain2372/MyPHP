	...
	<div class="row-fluid">
        <div id="main" class="span8">
            <?php foreach($post as $p){;?>
				<div class="artical">
					<hgroup>
						...
						<h4><i class="icon-calendar"></i><?php echo date('Y-m-d',$p['date']);?></h4>
					</hgroup>
			...
			<div id="pagenav" class="pagination">
				<ul>
					<li><a href="<?php createUrl('Post','search',isset($page)? $page-1:0);?>">Prev</a></li>
					<li><a href="<?php createUrl('Post','search',isset($page)? $page:1);?>"><?php echo isset($page)? $page:1;?></a></li>
					<li><a href="<?php createUrl('Post','search',isset($page)? $page+1:2);?>">Next</a></li>
				</ul>
			</div>
        </div>
