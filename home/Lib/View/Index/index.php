	...
	<div class="row-fluid">
        <div id="main" class="span8">
			...
			<div id="pagenav" class="pagination">
				<ul>
					<li><a href="<?php createUrl('Index','index',isset($page)? $page-1:0);?>">Prev</a></li>
					<li><a href="<?php createUrl('Index','index',isset($page)? $page:1);?>"><?php echo isset($page)? $page:1;?></a></li>
					<li><a href="<?php createUrl('Index','index',isset($page)? $page+1:2);?>">Next</a></li>
				</ul>
			</div>
        </div>
